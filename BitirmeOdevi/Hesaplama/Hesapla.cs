...
namespace BitirmeOdevi.Hesaplama
{
    ...
    {
        double sgkIsciPayiOranı = 0.14;
        double sgkIssizlikIsciPayiOranı = 0.01;
        double sgkIsverenPayiOranı = 0.155;
        double sgkIssizlikIsverenPayiOranı = 0.02;
        double damgaVergisi = 0.00759;
        ...
        public HesaplaModel NettenBrüte2(double netMaas, double gelirVergisi, double agi, double vergiMuhafiyeti)
        {
            HesaplaModel hesaplaModel = new HesaplaModel();
            double brütMaas;
        ...
        public HesaplaModel BrüttenNete2(double brütMaas, double gelirVergisi, double agi, double vergiMuhafiyeti)
        {
            HesaplaModel hesaplaModel = new HesaplaModel();
            double gelirVergisiMatrahi;
            double indirimSonrasiGelirVergisiMahrahi;
